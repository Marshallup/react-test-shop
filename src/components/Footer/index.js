								...
								<ul className="widget-posts">
									<li className="clearfix">
										<div className="widget-posts-image">
											<a href="#">
												<img src={require("assets/images/rp-1.jpg")} alt="Post Thumbnail"/>
											</a>
										</div>
									...
									<li className="clearfix">
										<div className="widget-posts-image">
											<a href="#">
												<img src={require('assets/images/rp-2.jpg')} alt="Post Thumbnail"/>
											</a>
										</div>
										<div className="widget-posts-body">
					...
					<div className="container">
						<div className="row">
							<div className="col-sm-6">
								<p className="copyright font-alt">&copy; 2017&nbsp;<a href="index.html">TitaN</a>, All Rights Reserved
								</p>
							</div>
							<div className="col-sm-6">
